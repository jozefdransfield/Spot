...
function Request() {
    ...
    this.send = function(callback) {
		...
		if (body) {
            ...
            req.setHeader("Content-Type", "multipart/form-data; boundary=----WebKitFormBoundarydfANBz6kTaOQhilX");
            //req.setHeader("Accept", "application/json");
            req.write("----WebKitFormBoundarydfANBz6kTaOQhilX");
            req.write("Content-Disposition: form-data; name=\"upfile\"; filename=\"BezierAnim.java")
            req.write("Content-Type: text/x-java")
            req.write("HELLO");
            req.write("----WebKitFormBoundarydfANBz6kTaOQhilX");
